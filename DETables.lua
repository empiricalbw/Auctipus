...
-- Green Weapon
local GREEN_WEAPON = {
    {ilvl=15,  results={{link=LESSER_MAGIC_ESSENCE,    percent=80, min=1, max=2},
                        {link=STRANGE_DUST,            percent=20, min=1, max=2}}},
    ...
    {ilvl=35,  results={{link=LESSER_MYSTIC_ESSENCE,   percent=75, min=1, max=2},
                        {link=SOUL_DUST,               percent=20, min=2, max=5},
                        {link=SMALL_GLOWING_SHARD,     percent=5,  min=1, max=1}}},
    {ilvl=40,  results={{link=GREATER_MYSTIC_ESSENCE,  percent=75, min=1, max=2},
                        {link=VISION_DUST,             percent=20, min=1, max=2},
                        {link=LARGE_GLOWING_SHARD,     percent=5,  min=1, max=1}}},
    {ilvl=45,  results={{link=LESSER_NETHER_ESSENCE,   percent=75, min=1, max=2},
                        {link=VISION_DUST,             percent=20, min=2, max=5},
                        {link=SMALL_RADIANT_SHARD,     percent=5,  min=1, max=1}}},
    {ilvl=50,  results={{link=GREATER_NETHER_ESSENCE,  percent=75, min=1, max=2},
    ...
    {ilvl=60,  results={{link=GREATER_ETERNAL_ESSENCE, percent=75, min=1, max=2},
                        ...
                        {link=LARGE_BRILLIANT_SHARD,   percent=5,  min=1, max=1}}},
    {ilvl=65,  results={{link=GREATER_ETERNAL_ESSENCE, percent=75, min=2, max=3},
                        {link=ILLUSION_DUST,           percent=20, min=2, max=5},
                        {link=LARGE_BRILLIANT_SHARD,   percent=5,  min=1, max=1}}},
    {ilvl=99,  results={{link=LESSER_PLANAR_ESSENCE,   percent=75, min=2, max=3},
                        {link=ARCANE_DUST,             percent=20, min=2, max=3},
                        {link=SMALL_PRISMATIC_SHARD,   percent=5,  min=1, max=1}}},
    {ilvl=120, results={{link=GREATER_PLANAR_ESSENCE,  percent=75, min=1, max=2},
                        {link=ARCANE_DUST,             percent=20, min=2, max=5},
                        {link=LARGE_PRISMATIC_SHARD,   percent=5,  min=1, max=1}}},
    {ilvl=151, results={{link=LESSER_COSMIC_ESSENCE,   percent=75, min=1, max=2},
                        {link=INFINITE_DUST,           percent=22, min=1, max=3},
                        {link=SMALL_DREAM_SHARD,       percent=3,  min=1, max=1}}},
    {ilvl=200, results={{link=GREATER_COSMIC_ESSENCE,  percent=75, min=1, max=2},
                        {link=INFINITE_DUST,           percent=22, min=4, max=7},
                        {link=DREAM_SHARD,             percent=3,  min=1, max=1}}},
}
...
local EPIC_ARMOR = {
    ...
    {ilvl=164, results={{link=VOID_CRYSTAL,             percent=67,  min=2, max=2},
                        {link=VOID_CRYSTAL,             percent=33,  min=1, max=1}}},
...
local EPIC_WEAPON = {
    ...
    {ilvl=80,  results={{link=NEXUS_CRYSTAL,            percent=67,  min=2, max=2},
                        {link=NEXUS_CRYSTAL,            percent=33,  min=1, max=1}}},
    {ilvl=88,  results={{link=NEXUS_CRYSTAL,            percent=100, min=1, max=2}}},
    {ilvl=100, results={{link=VOID_CRYSTAL,             percent=100, min=1, max=2}}},
...
function AuctipusGetDEInfo(itemID)
    ...
    local _, _, ilvl = GetDetailedItemLevelInfo(itemID)
